...
このガイドは、ドキュメントのタスクに Ralph Orchestrator を使う例を提供します。
...
### 1. コンテキストを提供する
プロンプトに、関連するコード構造、プロジェクトの種類、対象読者を含めます。

### 2. 形式を指定する
特定のドキュメント形式（Markdown、reStructuredText など）を求めます。

### 3. 例を含める
ドキュメントに使用例とコードスニペットを求めます。

### 4. セクションを求める
インストール、設定、API リファレンスなど、必要なセクションを指定します。

## 関連項目

- [プロンプトエンジニアリングガイド](../guide/prompts.ja.md)
- [Web API の例](./web-api.ja.md)
- [テストの例](./testing.ja.md)
