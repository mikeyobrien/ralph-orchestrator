//! # hats-core
//!
//! Core orchestration functionality for the Hats framework.
//!
//! This crate provides:
...
pub use config::{
    ...
    HatConfig, InjectMode, MemoriesConfig, MemoriesFilter, HatsConfig, SkillOverride,
    SkillsConfig,
};
...
pub use worktree::{
    ...
    list_hats_worktrees, list_worktrees, remove_worktree, sync_working_directory_to_worktree,
    worktree_exists,
};
