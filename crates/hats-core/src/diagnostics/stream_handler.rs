...
/// This struct is scaffolded for future production integration with hats-adapters.
#[allow(dead_code)]
...
mod tests {
    ...
    // We need to import StreamHandler trait - but it's in hats-adapters
    ...
    fn test_wrapper_calls_inner_handler() {
        ...
        logger.lock().unwrap().set_context(1, "hats");
