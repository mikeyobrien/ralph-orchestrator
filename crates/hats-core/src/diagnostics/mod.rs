//! Diagnostic logging system for Hats orchestration.
//!
//! Captures agent output, orchestration decisions, traces, performance metrics,
//! and errors to structured JSONL files when `HATS_DIAGNOSTICS=1` is set.
...
///
/// Checks `HATS_DIAGNOSTICS` environment variable and creates a timestamped
