//! Loop registry for tracking active Hats loops across workspaces.
//!
...
//! # Design
//!
//! - **JSON persistence**: Single JSON file at `.hats/loops.json`
...
//!
//! ```no_run
//! use hats_core::loop_registry::{LoopRegistry, LoopEntry};
//!
...
/// Registry for tracking active Hats loops.
///
...
impl LoopRegistry {
    ...
    pub const REGISTRY_FILE: &'static str = ".hats/loops.json";
...
mod tests {
    ...
    fn test_registry_creates_file() {
        ...
        let registry_path = temp_dir.path().join(".hats/loops.json");
