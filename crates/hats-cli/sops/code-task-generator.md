...
List generated files with paths. For PDD mode, include the step's demo requirements. Suggest running code-assist on tasks in sequence, or using Hats for autonomous implementation.

### 7. Offer Hats Integration

Ask: "Would you like me to set up Hats to implement these tasks autonomously?"
