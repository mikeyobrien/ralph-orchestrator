...
//!
//! Run with: cargo run -p hats-cli --example calculator -- <operation> <a> <b>
//!
//! Examples:
//!   cargo run -p hats-cli --example calculator -- add 5 3
//!   cargo run -p hats-cli --example calculator -- subtract 10 4
//!   cargo run -p hats-cli --example calculator -- multiply 6 7
//!   cargo run -p hats-cli --example calculator -- divide 20 4
