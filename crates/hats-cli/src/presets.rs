//! Embedded presets for hats init command.
//!
...
//! `crates/hats-cli/presets/` for `include_str!` to work with crates.io publishing.
...
mod tests {
    ...
    fn test_merge_loop_preset_is_embedded() {
        ...
        assert!(preset.content.contains("HATS_MERGE_LOOP_ID"));
