...
use hats_core::{EventRecord, TerminationReason};
use hats_proto::HatId;
...
pub fn build_tui_hat_map(registry: &hats_core::HatRegistry) -> HashMap<String, (HatId, String)> {
...
"#;
        ...
        let registry = hats_core::HatRegistry::from_config(&config);
