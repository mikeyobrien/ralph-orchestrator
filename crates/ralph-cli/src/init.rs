...
pub enum InitError {
    ...
    #[error(
        "Unknown backend '{0}'. Valid backends: claude, kiro, gemini, codex, amp, copilot, opencode, cursor, custom"
    )]
...
const VALID_BACKENDS: &[&str] = &[
    "claude", "kiro", "gemini", "codex", "amp", "copilot", "opencode", "cursor", "custom",
];
