...
//! Hats's hat system for coordinating specialized agent personas.
...
///
/// ```no_run
/// use hats_e2e::scenarios::{HatSingleScenario, TestScenario};
///
...
impl TestScenario for HatSingleScenario {
    ...
    fn setup(&self, workspace: &Path, backend: Backend) -> Result<ScenarioConfig, ScenarioError> {
        ...
        // Create hats.yml with a single custom hat
...
"#,
        ...
        let prompt = r#"You are testing Hats's hat system.
...
///
/// ```no_run
/// use hats_e2e::scenarios::{HatMultiWorkflowScenario, TestScenario};
///
...
impl TestScenario for HatMultiWorkflowScenario {
    ...
    fn setup(&self, workspace: &Path, backend: Backend) -> Result<ScenarioConfig, ScenarioError> {
        ...
        // Create hats.yml with planner and builder hats
        let config_content = format!(
...
"#,
        ...
        let prompt = r#"You are testing Hats's multi-hat workflow. Your FIRST action must be to emit this event EXACTLY as shown:
...
///
/// ```no_run
/// use hats_e2e::scenarios::{HatInstructionsScenario, TestScenario};
///
...
impl TestScenario for HatInstructionsScenario {
    ...
    fn setup(&self, workspace: &Path, backend: Backend) -> Result<ScenarioConfig, ScenarioError> {
        ...
        // Create hats.yml with a hat that has very specific instructions
        let config_content = format!(
...
"#,
        ...
        let prompt = r#"You are testing Hats's hat instruction system.
...
///
/// ```no_run
/// use hats_e2e::scenarios::{HatEventRoutingScenario, TestScenario};
///
...
impl TestScenario for HatEventRoutingScenario {
    ...
    fn setup(&self, workspace: &Path, backend: Backend) -> Result<ScenarioConfig, ScenarioError> {
        ...
        // Create hats.yml with multiple hats with distinct triggers
        let config_content = format!(
...
"#,
        ...
        let prompt = r#"You are testing Hats's event routing system.
...
///
/// ```no_run
/// use hats_e2e::scenarios::{HatBackendOverrideScenario, TestScenario};
///
...
impl TestScenario for HatBackendOverrideScenario {
    ...
    fn setup(&self, workspace: &Path, backend: Backend) -> Result<ScenarioConfig, ScenarioError> {
        ...
        // Create hats.yml with backend override configuration
...
"#,
        ...
        let prompt = r#"You are testing Hats's backend override configuration.
