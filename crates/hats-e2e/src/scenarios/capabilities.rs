...
//!
//! These scenarios test advanced agent capabilities through Hats:
//! - Tool invocation and response handling
//! - NDJSON streaming output parsing
//!
//! These tests verify that Hats correctly interfaces with backend
...
///
/// ```no_run
/// use hats_e2e::scenarios::{ToolUseScenario, TestScenario};
...
impl TestScenario for ToolUseScenario {
    ...
    fn setup(&self, workspace: &Path, backend: Backend) -> Result<ScenarioConfig, ScenarioError> {
        ...
        // Create backend-specific hats.yml
...
/// - Verifies that Hats correctly parses the streaming output
...
///
/// ```no_run
/// use hats_e2e::scenarios::{StreamingScenario, TestScenario};
/// use hats_e2e::Backend;
///
...
impl TestScenario for StreamingScenario {
    ...
    fn setup(&self, workspace: &Path, backend: Backend) -> Result<ScenarioConfig, ScenarioError> {
        ...
        // Create backend-specific hats.yml with streaming enabled
        let config_content = format!(
