...
Telegram integration for human-in-the-loop orchestration in Hats.
...
| `StateManager` | Persists state to `.hats/telegram-state.json` |
...
```bash
cargo test -p hats-telegram     # 33 unit tests
