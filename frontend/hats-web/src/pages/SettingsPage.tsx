 ...
 * SettingsPage
 *
 * Settings page for editing hats.yml configuration.
 * Features:
      ...
      <header className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Configure your Hats orchestrator
          </p>
        </div>
        <Badge variant="secondary">hats.yml</Badge>
      </header>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Edit your hats.yml configuration directly
              </CardDescription>
            </div>
          ...
          {configQuery.isLoading ? (
            ...
            <div className="space-y-4">
              <Textarea
                ...
                placeholder="# Hats configuration"
                spellCheck={false}
              />
